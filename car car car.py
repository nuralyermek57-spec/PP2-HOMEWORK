...
enemies.add(E1)
#New sprites group for money because if we put moneys in all_sprites then when we take the money game will end
...
#Coins counter display
    ...
    for entity in all_sprites:
        ...
        entity.move()
        #Moves and redraws coins
    for entity in moneys:
        DISPLAYSURF.blit(entity.image, entity.rect)
        entity.move()
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          ...
          pygame.quit()
          sys.exit() 
       #When collision between car and money occurs
